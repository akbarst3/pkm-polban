                    ...
                    <div class="col-md-10 pt-3">
                        ...
                        <div class=" d-flex align-items-center">
                            @if ($data['statusUpload'] === 'Sudah diupload')
                                <span class="text-success text-nowrap me-1"><strong>{{ $data ['statusUpload'] }}</strong></span>
                                <a href="{{ route('pengusul.lap-kemajuan.downloadFile', ['id' => $data['pkm']->id]) }}" class="btn btn-success btn-sm">Download</a>
                            @else
                                <span class="text-danger text-nowrap"><strong>{{ $data ['statusUpload'] }}</strong></span>
                                <form action="{{ route('pengusul.lap-kemajuan.uploadFile') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
