                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="phone" name="noHpMhs"
                                                    value="{{ $data['mahasiswa']->no_hp ?? '' }}"
                                                    {{ $data['mahasiswa']->no_hp ? 'disabled' : '' }}>
                                            </div>
                                            @error('noHpMhs')
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="phone_home"
                                                    name="noTelpRumahMhs" value="{{ $data['pengusul']->telp_rumah ?? '' }}"
                        ...
                        <div class="card-body">
                            <form action="{{ route('pengusul.edit-usulan.edit-pkm', $data['pkm']->id) }}" method="POST">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="dana_kemdikbud"
                                                ...
                                                {{ $data['pkm']->dana_kemdikbud ? 'disabled' : '' }}
                                                oninput="updateDana()" required>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="dana_pt" name="dana_pt"
                                                ...
                                                {{ $data['pkm']->dana_pt ? 'disabled' : '' }} oninput="updateDana()"
                                                required>
                                        </div>
                                        @error('dana_pt')
                                            <small class="error text-danger">{{ $message }}</small>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="dana_insentif_lain">Dana Instansi Lain (Opsional)</label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="instansi_lain">Nama Instansi lain (Sebutkan nama
                                                instansinya)</label>
