                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="field col-md-6">
                                <p>: {{ $viewData['alamatPengusul'] }} , {{ $viewData['noHpPengusul'] }},
                                    {{ $viewData['telpRumahPengusul'] }}</p>
                            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="field col-md-6">: <input type="number"
                                    class="inline-input @error('waktu_pelaksanaan') is-invalid @enderror"
