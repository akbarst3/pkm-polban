                                    ...
                                    <tbody>
                                        @foreach ($namaSkema as $idSkema => $skema)
                                            <tr>
                                                ...
                                                {{-- Ambil data judulCounts --}}
                                                <td>{{ $dataPkms[0]['judulCounts'][$idSkema] ?? 0 }}</td>

                                                {{-- Ambil data proposalCounts --}}
                                                <td>{{ $dataPkms[1]['proposalCounts'][$idSkema] ?? 0 }}</td>

                                                {{-- Ambil data pengisianCounts --}}
                                                <td>{{ $dataPkms[2]['pengisianCounts'][$idSkema]['count'] ?? 0 }}</td>

                                                {{-- Ambil data validasiCounts val_dospem --}}
                                                <td>{{ $dataPkms[3]['validasiCounts']['val_dospem'][$idSkema] ?? 0 }}</td>

                                                {{-- Ambil data validasiCounts val_pt --}}
