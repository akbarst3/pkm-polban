            ...
            <div class="sidebar-wrapper">
                <div class="sidebar-wrapper">
                    <div class="sidebar-info text-center" style="padding: 5px;">
                        <p>Opt. PT PKM</p>
                        <p>[{{ $perguruanTinggi->kode_pt }}] {{ $perguruanTinggi->nama_pt }}</p>
                    </div>
                    <nav class="mt-2"> <!--begin::Sidebar Menu-->
                        <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu"
                            data-accordion="false">
                            <li class="nav-item"> <a href="/operator/dashboard" class="nav-link"> <i
                            ...
                            <li class="nav-item"> <a href="#" class="nav-link"> <i
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="{{ route('operator.usulan.baru') }}" class="nav-link"
                                            @if ($statusFiles['beritaAcaraPendanaan'] == false) style="pointer-events: none; cursor: default;" @endif>
                                            <p>Daftar Usulan</p>
                                        </a>
                                    </li>
                                </ul>
