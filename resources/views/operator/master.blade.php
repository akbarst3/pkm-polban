            ...
            <div class="sidebar-wrapper">
                ...
                <nav class="mt-2">
                    <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <a href="#" class="nav-link {{ Request::is('operator/daftar-usulan') ? 'active' : '' }}">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('operator.daftar-usulan.') }}" class="nav-link" @if ($statusFiles['beritaAcaraPendanaan'] == false) style="pointer-events: none; cursor: default;" @endif>
                        ...
                        <li class="nav-item">
                            <a href="{{ route('operator.usulan-didanai') }}" class="nav-link {{ Request::is('operator/usulan-didanai') ? 'active' : '' }}">
                                <i class="nav-icon bi bi-calendar"></i>
                                <p>Usulan Didanai</p>
                            </a>
                        </li>
