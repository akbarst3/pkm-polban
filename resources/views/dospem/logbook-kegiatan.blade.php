                        ...
                        <tbody>
                            @foreach ($data['logbooks'] as $logbook)
                                <tr>
                                    ...
                                    <td class="align-middle">{{ $logbook->uraian }}</td>
                                    <td class="align-middle">{{ $logbook->capaian }}%</td>
                                    <td class="align-middle">{{ $logbook->waktu_pelaksanaan }}</td>
                                    ...
                                    <td class="align-middle">
                                        @if ($logbook->validasi === null)
                                            <form
                                                action="{{ route('dosen-pendamping.validasi-logbook.logbook-kegiatan.approve', $logbook->id) }}"
                                            ...
                                            <form
                                                action="{{ route('dosen-pendamping.validasi-logbook.logbook-kegiatan.reject', $logbook->id) }}"
                                                method="POST" style="display: inline;">
                                                @csrf
                                                @method('PATCH')
