...
<body class="layout-fixed sidebar-expand-lg bg-body-tertiary"> <!--begin::App Wrapper-->
    <div class="app-wrapper"> <!--begin::Header-->
        ...
        <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="light"> <!--begin::Sidebar Brand-->
            <div class="sidebar-brand"> <!--begin::Brand Link--> <a href="./index.html"> <!--begin::Brand Image--> <img
                        src="{{ asset('images/PKMPOLBAN.png') }}" alt="PKM POLBAN" class="img-fluid"
                        style="max-width: 120px;"> <!--end::Brand Image--> <!--begin::Brand Text--> <span
                ...
                <div class="sidebar-wrapper">
                    ...
                    <nav class="mt-2"> <!--begin::Sidebar Menu-->
                        <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu"
                            ...
                            <li class="nav-item"> <a href="/pengusul/dashboard" class="nav-link"> <i
                            ...
                            <li class="nav-item"> <a href="#" class="nav-link"> <i
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item"> <a href="/dospem/validasiusulan" class="nav-link">
                                            <p>Proposal</p>
                                        </a>
                                    </li>
                                </ul>
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="/pengusul/pelaksanaanKegiatan" class="nav-link"> <i
                                        class="nav-icon bi bi-trophy"></i>
                                    <p>Sertifikat</p>
                                </a>
                            <li class="nav-item">
                                <form action="/pengusul/logout" method="post">
                                    @csrf
                    ...
                    <div class="bottom-components d-flex justify-content-between position-absolute w-100"
                        style="bottom: 0; padding: 22px;">
                        <a href="./generate/theme.html"
                            class="nav-link text-center d-flex flex-column align-items-center">
